...
<body id="inicio">
  ...
  <div class="subtitle-header"><strong>Experiencia interactiva con Teoría de Conjuntos</strong></div>
...
!-- Módulo A: Álgebra de Conjuntos -->
  ...
  <div class="form-group">
   ...
   <div id="setResults" style="margin-top: 15px; font-family: monospace; font-size: 0.95em;">
        ...
        <p><strong>A Δ B (Diferencia Simétrica):</strong> <span id="resSymDiff">-</span></p>
        <p><strong>P(A) (Conjunto Potencia):</strong> <span id="resPowerA">-</span></p>
      </div>
    </div>
...
!-- Módulo B: Producto Cartesiano -->
  ...
  !-- Módulo C: Paradoja de Russell -->
   <div id="russell" class="tab-content">
      ...
      <div class="form-group">
        <select id="russellChoice" onchange="testRussell()">
      ...
      <div id="russellResult" style="margin-top: 15px; font-weight: bold; font-size: 0.95em;"></div>
    </div>
  </div>
